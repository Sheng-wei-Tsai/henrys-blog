    ...
    <div className="job-card" style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem', marginBottom: '0.5rem' }}>
        <button
          ...
          style={{
            background: isSaved ? 'var(--warm-white)' : undefined,
...
export default function JobsPage() {
  ...
  return (
    <div style={{ maxWidth: '760px', margin: '0 auto', padding: '0 1.5rem' }}>
      ...
      {error && (
        <div role="alert" style={{ background: 'rgba(232, 64, 64, 0.12)', border: '1px solid var(--vermilion)', borderRadius: '10px', padding: '1rem', marginBottom: '1rem', color: 'var(--vermilion)', fontSize: '0.9rem' }}>
          {error}
        </div>
      )}

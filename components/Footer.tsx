...
const COL_TOOLS = [
  ...
  { href: '/dashboard/resume-analyser', label: 'Resume Analyser' },
  { href: '/interview-prep',   label: 'Interview Prep' },
  { href: '/learn',            label: 'Learning Paths' },
  { href: '/au-insights',      label: 'AU Insights' },
...
const COL_CONTENT = [
  ...
  { href: '/posts/research', label: 'AI Digest' },
  { href: '/posts/githot',   label: 'Githot' },
      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '3rem 1.5rem 2rem' }}>
        ...
        <div className="footer-cols" style={{ marginBottom: '2.5rem' }}>
          ...
          <div style={{ flex: '1 1 180px', minWidth: '160px' }}>
            <div style={{ fontFamily: "'Lora', serif", fontWeight: 700, fontSize: '1.1rem', color: 'var(--brown-dark)', marginBottom: '0.5rem' }}>
              TechPath AU
            </div>
            ...
            <div style={{ display: 'flex', gap: '0.75rem', marginTop: '1rem' }}>
              <a href="https://github.com/Sheng-wei-Tsai" target="_blank" rel="noopener noreferrer" aria-label="GitHub" style={iconLink}>
              ...
              <a href="https://www.linkedin.com/in/sheng-wei-tsai/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" style={iconLink}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div style={{ borderTop: '1px solid var(--parchment)', paddingTop: '1.25rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '0.5rem' }}>
          <p style={{ fontFamily: "'Caveat', cursive", fontSize: '1rem', color: 'var(--text-muted)', margin: 0 }}>
            Made with warmth & curiosity ☕
          </p>
          <p style={{ fontSize: '0.75rem', color: 'var(--text-muted)', margin: 0 }}>
            © {new Date().getFullYear()} Henry Tsai · Built with Next.js · Hosted on Vercel
          </p>
        </div>
